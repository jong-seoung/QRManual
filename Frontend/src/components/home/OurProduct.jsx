const OurProduct = () => {
  return (
    <div className="py-20 px-4 lg:px-40 bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-[1100px] mx-auto">
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-text-main dark:text-white mb-4">
            Everything you need to manage docs
          </h2>
          <p className="text-text-light dark:text-slate-400 max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex gap-4 items-start">
            <div className="shrink-0 size-10 rounded-lg bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center text-primary border border-slate-200 dark:border-slate-700">
