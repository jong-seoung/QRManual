const Dashboard = ({ onSwitch }) => {
  return (
    <main className="flex-1 flex flex-col h-full overflow-hidden relative">
      {/* <!-- Mobile Header --> */}
      <header className="lg:hidden h-16 bg-surface-light dark:bg-surface-dark border-b border-border-light dark:border-border-dark flex items-center justify-between px-4 shrink-0">
        <div className="flex items-center gap-3">
          <span className="material-symbols-outlined text-slate-600 dark:text-slate-300">
            menu
          </span>
          <span className="font-bold text-lg">DocuQR</span>
        </div>
        <div
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 scroll-smooth">
        <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm">
            <div className="flex gap-5 items-center">
              <div className="size-20 rounded-xl bg-slate-100 dark:bg-slate-800 border border-border-light dark:border-border-dark flex items-center justify-center p-2 relative shrink-0">
                <div
                ...
                ></div>
                <div
                  className="absolute -bottom-2 -right-2 bg-green-500 text-white rounded-full p-1 border-2 border-white dark:border-surface-dark"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* <!-- Stat Card 1 --> */}
            <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col gap-1">
            ...
            <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col gap-1">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="material-symbols-outlined text-orange-500 bg-orange-500/10 p-1.5 rounded-lg text-xl">
                  confirmation_number
                </span>
              </div>
              <p className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-bold">QR Scan Trends</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    Scan performance over last 30 days
                  </p>
                </div>
                <select className="bg-background-light dark:bg-background-dark border-border-light dark:border-border-dark rounded-lg text-sm px-3 py-1.5 focus:ring-primary focus:border-primary">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm p-6">
                ...
                <div className="flex flex-col gap-3">
                  <button className="flex items-center gap-3 p-3 rounded-lg border border-border-light dark:border-border-dark hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-left group">
                    <div className="size-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
              ...
              {/* <!-- Support Widget --> */}
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl shadow-sm p-6 text-white relative overflow-hidden">
                <div className="relative z-10">
                  <div className="size-10 rounded-full bg-white/10 flex items-center justify-center mb-4 backdrop-blur-sm">
                  ...
                  <button className="w-full py-2 px-4 bg-white text-slate-900 rounded-lg text-sm font-bold hover:bg-slate-100 transition-colors">
                    Open Ticket
                  </button>
                </div>
                <div className="absolute top-0 right-0 size-32 bg-primary/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="bg-background-light dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 font-medium">
                  <tr>
                ...
                <tbody className="divide-y divide-border-light dark:divide-border-dark">
                  ...
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          className="size-10 rounded-lg bg-slate-100 dark:bg-slate-800 bg-cover bg-center border border-border-light dark:border-border-dark"
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800 dark:bg-emerald-500/20 dark:text-emerald-400">
                    ...
                    <td className="px-6 py-4 text-right">
                      ...
                      <button className="text-slate-400 hover:text-primary transition-colors p-1 ml-2">
                        <span className="material-symbols-outlined text-xl">
                          bar_chart
                        </span>
                      </button>
                  ...
                  <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      ...
                      <button className="text-slate-400 hover:text-primary transition-colors p-1 ml-2 opacity-50 cursor-not-allowed">
                        <span className="material-symbols-outlined text-xl">
                          bar_chart
                        </span>
                      </button>
